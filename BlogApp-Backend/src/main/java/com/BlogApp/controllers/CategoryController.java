...
public class CategoryController {
	...
	public ResponseEntity<CategoryDto> updateCategoryById(@PathVariable Integer cid,
	...
	public ResponseEntity<ApiResponse> deleteCategoryById(@PathVariable Integer cid) {
